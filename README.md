...
All datasets used in the experiments can be found in the "datasets" folder. The Jupyter notebooks contain the code of the applications, while the .py are files with auxiliary functions. The Jupyter notebooks are as follows:
